...
// CLASES DE DATOS
    ...
    // Ejemplo:
        ...
        // Clase Cliente en Java que sólo contiene datos sobre un Cliente y no tiene ninguna funcionalidad:
    ...
    // (clase de datos) -> es como una clase normal pero con algunas funcionalidades adicionales.

    // Con las clases de datos de Kotlin, no necesitas escribir/generar tú mismo todo el código boilerplate. El
    // compilador genera automáticamente un getter y setter por defecto para todas las propiedades mutables, y un getter
    // (sólo) para todas las propiedades de sólo lectura. Además, también deriva la implementación de métodos estándar
    ...
    // REQUISITOS PARA CLASES DE DATOS
            ...
            // - Todos los parámetros declarados en el constructor primeraio necesita ser declarado como val o var.
            // - Las clases de datos no pueden ser clases abstractas, abiertas, selladas o inner.


    // Además de los métodos estándar como equals(), hashCode() y toString(), Kotlin también genera una función copy() y
    // funciones componentN() para todas las clases de datos:

        // FUNCION COPY E INMUTABILIDAD

            // Aunque las propiedades de una clase de datos pueden ser mutables (declaradas con var), se recomienda
            // encarecidamente utilizar propiedades inmutables (declaradas con val) para mantener las instancias de la
            // clase de datos inmutables.

            // Los objetos inmutables son más fáciles de trabajar y razonar cuando se trabaja con aplicaciones multihilo.
            // Dado que no pueden ser modificados después de su creación, no tienes que preocuparte por los problemas de
            // concurrencia que surgen cuando varios hilos intentan modificar un objeto al mismo tiempo.
        ...
        // DECLARACION DE DESESTRUCTURACION: Las funciones componentN()
            ...
            // Kotlin también genera funciones componentN() correspondientes a todas las propiedades declaradas en el
            // constructor primario de la clase de datos.

            // Para la clase de datos Customer que hemos definido en la sección anterior, Kotlin genera dos funciones
            // component1() y component2() correspondientes a las propiedades id y name:
